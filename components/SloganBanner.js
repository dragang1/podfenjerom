    ...
    <section className="block-banner" aria-label="Anegdota">
      <div className="block-banner_inner">
        ...
        <RevealOnView type="slide-x" as="p" className="block-banner_text">
          ...
          pripremili, njegovi prijatelji su pečenje odvezli do aerodroma u
          Mahovljanima, gdje je privatni avion gospodina Eklstona čekao da
          specijalitet iz naše kuće krene put Engleske.
        </RevealOnView>
      </div>
    </section>
  );
